<h1>Session Memory <img src="/images/child-workflows-icon.svg" alt="Session Memory" class="pattern-page-icon"></h1>

## Overview

Store summaries in session state between turns.
...
See `sandbox-runner/patterns/session-memory/python/` when a live sample exists for this pattern.
