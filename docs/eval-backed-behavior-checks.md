<h1>Eval-Backed Behavior Checks <img src="/images/child-workflows-icon.svg" alt="Eval-Backed Behavior Checks" class="pattern-page-icon"></h1>

## Overview

Regression checks on recorded sessions.
...
See `sandbox-runner/patterns/eval-backed-behavior-checks/python/` when a live sample exists for this pattern.
