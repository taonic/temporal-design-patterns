<h1>Agent Tracing <img src="/images/child-workflows-icon.svg" alt="Agent Tracing" class="pattern-page-icon"></h1>

## Overview

Correlate spans with session and step IDs.
...
See `sandbox-runner/patterns/agent-tracing/python/` when a live sample exists for this pattern.
