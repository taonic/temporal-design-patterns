<h1>Session-Scoped Approvals <img src="/images/child-workflows-icon.svg" alt="Session-Scoped Approvals" class="pattern-page-icon"></h1>

## Overview

Approve a tool for the rest of a session.
...
See `sandbox-runner/patterns/session-scoped-approvals/python/` when a live sample exists for this pattern.
