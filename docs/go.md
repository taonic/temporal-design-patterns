...
- Temporal's durable execution guarantees compensations will execute even after Worker failures.
...
- More complex than ACID transactions.
...
- May use **Async Activity Completion** when compensations require external approval
...
## Business process and human-in-the-loop patterns
