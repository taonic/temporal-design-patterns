<h1>Network & Resource Sandboxing <img src="/images/child-workflows-icon.svg" alt="Network & Resource Sandboxing" class="pattern-page-icon"></h1>

## Overview

Bound sandboxes as data planes under Workflow control.
...
See `sandbox-runner/patterns/network-resource-sandboxing/python/` when a live sample exists for this pattern.
