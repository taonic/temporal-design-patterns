<h1>Messaging Channel Agent <img src="/images/child-workflows-icon.svg" alt="Messaging Channel Agent" class="pattern-page-icon"></h1>

## Overview

Map Slack or email into sessions.
...
See `sandbox-runner/patterns/messaging-channel-agent/python/` when a live sample exists for this pattern.
